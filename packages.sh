...
yay -S google-chrome brave-bin pycharm-community-edition code epson-inkjet-printer-escpr sonobus reaper sddm-silent-theme fontbase ttf-cascadia-nerd ttf-bree-serif sane-airscan
